...
$(document).ready(function(){$(".header-carousel").owlCarousel({autoPlay:3e3,items:1,itemsDesktop:[1199,3],itemsDesktopSmall:[979,3],loop:!0,autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0,smartSpeed:1e3}),$("#my-menu").mmenu({configuration:{hardwareAcceleration:!1},extensions:["theme-dark","fx-menu-slide","pagedim-black","position-right"],navbar:{title:'<img src="../img/logo.png">'},navbars:[{position:"top",content:["breadcrumbs","close"]}]});var e=$("#my-menu").data("mmenu");$(".hamburger").click(function(){e.open()});var a=$(".hamburger");a.on("click",function(e){a.toggleClass("is-active")}),e.bind("open:finish",function(e){$(".hamburger").addClass("is-active")}),e.bind("close:finish",function(e){$(".hamburger").removeClass("is-active")})});